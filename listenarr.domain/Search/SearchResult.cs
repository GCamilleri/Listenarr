...
namespace Listenarr.Domain.Search
{
    ...
    public abstract class BaseSearchResult
    {
        ...
        /// <summary>
        /// Confidence, 0 to 1, that this result is the book the caller described. Null when the
        /// request carried nothing to score against. See LibraryMatchScorer.
        /// </summary>
        public double? MatchScore { get; set; }

        /// <summary>
        /// Short human-readable notes behind <see cref="MatchScore"/>, for the UI to explain why
        /// a row did or did not match.
        /// </summary>
